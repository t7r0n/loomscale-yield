...
from biofabric_yield_twin_local.engine import (
    LocalHarness,
    benchmark,
    export_demo_pack,
    jsonl_loop,
...
from biofabric_yield_twin_local.fixtures import init_store, load_config, load_scenarios
...
def test_benchmark_and_cli_smoke():
    result = subprocess.run(
        [sys.executable, "-m", "biofabric_yield_twin_local.cli", "init-demo", "--force"],
        check=True,
        capture_output=True,
        text=True,
    )
